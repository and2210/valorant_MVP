...
class AppController:
    ...
    def get_overlay_snapshot(self) -> dict[str, Any]:
        ...
        return {
            ...
            "missed_brake_count": int(input_stats.missed_brake_count),
            "last_strong_context": str(input_stats.last_strong_context or "precision_weapon"),
            "temporary_context": str(input_stats.temporary_context or ""),
            "effective_input_context": str(input_stats.effective_input_context or "precision_weapon"),
            "context_expires_in_ms": int(input_stats.context_expires_in_ms or 0),
            "last_lmb_classification": str(input_stats.last_lmb_classification or "ignored_safe"),
