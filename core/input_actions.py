...
DEFAULT_ACTIONS: dict[str, InputAction] = {
    ...
    "1": InputAction("1", "weapon_slot_1", "weapon", "neutral", "1"),
    "2": InputAction("2", "weapon_slot_2", "weapon", "neutral", "2"),
    "3": InputAction("3", "knife_slot", "weapon", "neutral", "3"),
    ...
    "v": InputAction("v", "communication", "communication", "neutral", "V"),
